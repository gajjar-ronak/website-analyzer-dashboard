  ...
  return (
    <div className='space-y-6'>
      ...
      <div>
        ...
        <p className='mt-1 text-sm text-gray-500'>Overview of your website monitoring</p>
      </div>
              ...
              {urlsData.urls.slice(0, 5).map(url => (
                ...
                >
                  ...
                  <div className='text-right'>
                    ...
                    <p className='text-xs text-gray-500'>{url.statusCode || '-'}</p>
                  </div>
                </div>
              ))}
            </div>
